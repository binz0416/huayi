...
<body>
	<h2>用户管理</h2>
	<form id="ff">
	查看：/ghealth/toxindetection/list<br/>
	新增：/ghealth/toxindetection/additional<br/>
	编辑：/ghealth/toxindetection/edit<br/>
	删除：/ghealth/toxindetection/dele<br/>
	URL:<textarea rows="1" cols="" style="width: 80%;margin: 5px;" id="url"><%=request.getContextPath()%>/toxindetection/list</textarea><br/>
