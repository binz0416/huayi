...
<body>
	<h2>用户管理</h2>
	<form id="ff">
	查看：/ghealth/imagecheck/list<br/>
	新增：/ghealth/imagecheck/additional<br/>
	编辑：/ghealth/imagecheck/edit<br/>
	删除：/ghealth/imagecheck/dele<br/>
	URL:<textarea rows="1" cols="" style="width: 80%;margin: 5px;" id="url"><%=request.getContextPath()%>/imagecheck/list</textarea><br/>
